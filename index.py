...
top10seed_avg_ADJOE = top10seed_data['ADJOE'].mean().round(1)
...
means = {  
    ...
    'Top 10 Seeds': [top10seed_avg_ADJOE, top10seed_avg_ADJDE, top10seed_avg_EFG0, top10seed_avg_EFGD, top10seed_avg_tempo]
}
